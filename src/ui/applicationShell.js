...
export class StyleManager {
  ...
  _initUI() {
    ...
    // Kontrol kamera papan ketik: WASD menggeser, G/F memutar pandangan 3D.
    // Dinonaktifkan selagi mode kokpit mengemudikan kamera, agar dua sumber
    // kendali tidak saling berebut pada frame yang sama.
